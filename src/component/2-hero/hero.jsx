      ...
      <div className="left-section">
        <div className="parant-yousef flex">
          ...
          <p className="subtitle">
            ...
            JavaScript, and React. Skilled in building responsive, user-friendly
            web interfaces using modern frameworks and tools such as Next.js and
            Tailwind CSS. Proficient in integrating and handling APIs to create
            seamless, dynamic interactions and ensure efficient data flow across
            applications. Passionate about leveraging cutting-edge technologies
            to craft intuitive and engaging user experiences, with a focus on
            performance and scalability. Eager to contribute to dynamic
            development teams and thrive in a professional environment that
